...
export const pricingPlans = [
  {
    ...
    delivery: '10 days',
    revisions: '2 rounds',
    support: 'Basic hosting guidance',
    features: ['1-page launch site', 'Mobile-first design', 'Contact form setup'],
    popular: false,
  },
  {
    name: 'Business',
    ...
    delivery: '2-3 weeks',
    revisions: '3 rounds',
    support: 'Hosting handoff + setup',
    features: ['Multi-page website', 'SEO-ready structure', 'Analytics setup'],
    popular: true,
  },
  {
    name: 'Premium',
    ...
    features: ['Custom web app', 'Design system', 'Integration support'],
    popular: false,
  },
];
