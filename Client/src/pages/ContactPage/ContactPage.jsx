      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-[2] flex flex-col items-center text-center px-6 max-w-[800px] mt-[86px]">
          ...
          <div className="flex flex-row gap-6 mt-10 justify-center animate-[ch-fadein_0.9s_ease_0.6s_both]">
            <a href="https://www.linkedin.com/company/fidarix/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-16 h-16 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-white no-underline group hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(255,255,255,0.1)]" aria-label="LinkedIn">
            ...
            <a href="mailto:info@fidarix.com" className="flex items-center justify-center w-16 h-16 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-white no-underline group hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(255,255,255,0.1)]" aria-label="Email Us">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:text-primary transition-colors">
