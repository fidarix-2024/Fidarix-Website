    ...
    <div className="bg-[#050505] text-white min-h-screen">
      ...
      <section className="relative w-full min-h-[60vh] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-[2] flex flex-col items-center text-center px-6 max-w-[800px] mt-[86px]">
          ...
          <div className="flex flex-row gap-6 mt-10 justify-center animate-[ch-fadein_0.9s_ease_0.6s_both]">
            ...
            <div className="relative w-full sm:w-[calc(100%-14px)] h-full sm:h-[calc(100%-14px)]">
              ...
              <div className="relative w-full h-full bg-white border border-[#111] rounded p-[36px_28px] sm:p-[44px_40px] z-[2] flex flex-col justify-between shadow-none gap-6 sm:gap-0">
                ...
                <div className="flex flex-col mb-4 sm:mb-0">
                  ...
                  <p className="font-['Manrope'] text-[15px] leading-[1.6] text-[#555] m-0">Monday - Friday : 9:00am - 9:00pm</p>
                </div>

                <div className="flex flex-col">
                  <h3 className="font-['Space_Grotesk'] text-[28px] font-bold text-[#111] m-0 mb-2.5">Stay Connected</h3>
                  <div className="flex gap-3 mt-3">
                    <a href="https://wa.me/1234567890" className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-black text-white transition-all duration-200 hover:scale-110 hover:bg-[#222] [&>svg]:block" target="_blank" rel="noreferrer" aria-label="WhatsApp">
                    ...
                    <a href="https://linkedin.com" className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-black text-white transition-all duration-200 hover:scale-110 hover:bg-[#222] [&>svg]:block" target="_blank" rel="noreferrer" aria-label="LinkedIn">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                      </svg>
                    </a>
                    <a href="https://instagram.com" className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-black text-white transition-all duration-200 hover:scale-110 hover:bg-[#222] [&>svg]:block" target="_blank" rel="noreferrer" aria-label="Instagram">
